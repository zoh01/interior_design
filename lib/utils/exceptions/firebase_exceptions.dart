  ...
  String get message {
    switch (code) {
      ...
      case 'email-already-in-use':
        return 'The email address is already registered. Please use another email.';
      case 'wrong-password':
        return 'Incorrect password. Please check your password and try again.';
      case 'weak-password':
        return 'The password is too weak. Please check your password and try again.';
      ...
      case 'requires-recent-login':
        return 'This operation is sensitive and requires authentication. Please log in again.';
      case 'quota-exceeded':
      ...
      case 'missing-action-code':
        return 'The action code is missing. Please provide a valid recipient email.';
      case 'user-token-expired':
        return 'The user\'s token has expired and authentication has expired. Please sign-in again.';
