...
import 'package:interior_design/features/authentication/screens/product_review/product_review.dart';
import 'package:interior_design/features/authentication/screens/product_screen/widgets/product_color.dart';
...
class ZProduct_info extends StatelessWidget {
  ZProduct_info({
    super.key,
  });

  List<ColorProduct> colorList = [
    ColorProduct(ZImages.drawer, 'Black', Colors.white, () {}),
    ColorProduct(ZImages.offwhite, 'Off-White', Colors.white70, () {})
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('\$999.0', style: Theme.of(context).textTheme.headlineSmall!.apply(color: Colors.black),),
                const Row(
                  children: [
                    Text('Seller: ', style: TextStyle(color: Colors.black38),),
                    Text('Warizoh', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),)
                  ],
                )
