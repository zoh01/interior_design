...
import '../../../../authentication/screens/product_screen/widgets/color.dart';
import '../../../../authentication/screens/product_screen/widgets/product_color.dart';

class ZBedInfo extends StatelessWidget {
  ZBedInfo({super.key});

  List<ColorProduct> colorList = [
    ColorProduct(ZImages.kingBed2, 'Grey', Colors.grey, () { }),
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('\$9199.0', style: Theme.of(context).textTheme.headlineSmall!.apply(color: Colors.black),),
                const Row(
                  children: [
                    Text('Seller: ', style: TextStyle(color: Colors.black38),),
                    Text('Pizzu', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),)
                  ],
                )
